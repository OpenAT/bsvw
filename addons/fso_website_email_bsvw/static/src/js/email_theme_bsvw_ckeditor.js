...
(function () {
    ...
    openerp.website.RTE = openerp.website.RTE.extend({
        _config: function () {
            ...
            config.colorButton_colors = 'ffffff,000000,f6f6f5,1f1f1f,393';
            ...
            config.stylesSet = [
                ...
                {name: 'p Klein', element: 'p', attributes: { 'class': 'bsvw_small' } },
                {name: 'p Winzig', element: 'p', attributes: { 'class': 'bsvw_tiny' } },
                {name: 'H1', element: 'h1'},
                {name: 'H2', element: 'h2'},
                {name: 'H3', element: 'h3'},
                {name: 'H4', element: 'h4'},
                ...
                // {name: 'Klein', element: 'span', attributes: { 'class': 'bsvw_small_text' } },
                // {name: 'Sehr-Klein', element: 'span', attributes: { 'class': 'bsvw_very_small_text' } },
            ];
